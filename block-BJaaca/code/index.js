...
character['greet'] = function() { alert(`I am Vipul and my title is Anand`);};
...
character['greet'] = function() { alert(`Se is here and her title is Anand`);};
...
character.changeIsAdult = function() {character.isAdult = (character.isAdult ? false : true)};
