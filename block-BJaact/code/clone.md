...
console.log(person.firstName === personTwo.firstName); // Arya
...
// Using Object.asign() function 
const blogs2 = Object.assign({}, blogs);

// Using Json Parsing
const blogs3 = JSON.parse(JSON.stringify(data));

// Using structuredClone()
const blogs4 = structuredClone(blogs);
...
// Your code goes here
var allBlogsClone = Object.assign({}, allBlogs);
```
