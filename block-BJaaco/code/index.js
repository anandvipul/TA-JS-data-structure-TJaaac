...
for (let i = 0; i < numbers.length; i ++) {
  collection[0] += numbers[i]
}

for (let i = 0; i < userIds.length; i ++) {
  collection[0] += userIds[i]
}
...
for (let i = 0; i < numbers.length; i ++) {
  if (numbers[i] %2 == 0) {
    evenCollection[0] += numbers[i];
  }
}

for (let i = 0; i < userIds.length; i ++) {
  if ( userIds[i] %2 == 0) {
    evenCollection[0] += userIds[i];
  }
}
...
for (let i = 0; i < numbers.length; i ++) {
  if (numbers[i] %2 != 0) {
    oddCollection[0] += numbers[i];
  }
}

for (let j = 0; j < userIds.length; j++) {
  if (userIds[j] %2 != 0) {
    oddCollection[0] += userIds[i];
  }
}
...
function revert(arr) {
  ...
  for (let i = arr.length-1; i >= 0; i--) {
    arrReversed[arr.length-i] = arr[i];
  }
  return arrReversed;
}
