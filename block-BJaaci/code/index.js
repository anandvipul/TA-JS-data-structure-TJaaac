...
console.log(movies[0]['actors'][movies[0]['actors'].length-2]);
...
console.log(movies[2]['actors'][movies[0]['actors'].length-2]);
...
console.log(movies[0]['genres'][movies[1]['genres'].length - 1]);
...
for (let j = 1; j < movies[1]['genres'].length; j ++ ) {
  console.log(movies[1]['genres'][j-1]);
}
...
for (let i = 0; i < movies.length ; i++) {
  (movies[i]['genres'].length > 1) ? console.log(movies[i].title) : console.log("");
}
// 28. Log the name of all the movies with more than 1 actors
for (let i = 0; i < movies.length ; i++) {
  (movies[i]['actors'].length > 1) ? console.log(movies[i].title) : console.log("");
}
// 29. Log the name of all the movies with exactly 3 actors
for (let i = 0; i < movies.length ; i++) {
  (movies[i]['actors'].length == 3) ? console.log(movies[i].title) : console.log("");
}
// 30. Log the name of all the movies with year `2018`
for (let i = 0; i < movies.length ; i++) {
  (movies[i]['year'] == 2018) ? console.log(movies[i].title) : console.log("");
}